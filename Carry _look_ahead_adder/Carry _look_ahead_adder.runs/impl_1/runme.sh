...
HD_PWD='C:/Users/Amr/Documents/verliog_projects/Carry _look_ahead_adder/Carry _look_ahead_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CLA_64_Bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CLA_64_Bit.tcl -notrace
